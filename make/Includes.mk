...
OBJS = $(addprefix $(BUILDDIR), $(patsubst %.cc, %.o, $(SOURCES:.c=.o)))    
DEBUG_OBJS = $(addprefix $(BUILDDIR), $(patsubst %.cc, %.o, $(SOURCES:.c=.o-debug)))    
DEPS = $(addprefix $(BUILDDIR), $(patsubst %.cc, %.o, (SOURCES:.c=.d)))
